...
public class ItemCrystallineSolid extends Item
{
    public ItemCrystallineSolid()
    {
        super(new Item.Properties().group(TantalusUnchained.creativeTab));
        setRegistryName(new ResourceLocation(TantalusUnchained.MODID, "crystalline_solid"));
    }
